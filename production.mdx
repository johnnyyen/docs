...
<Tip>We recommend keeping those parameters in your environemnt specific configuration.</Tip>
...
This allows you to test the end-to-end flow in production to uncover any environment specific problems without affecting customers.

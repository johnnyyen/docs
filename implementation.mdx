...
When you call any financial endpoint ([payout](/v1/api-reference/payouts/request-payout), [deposit](/v1/api-reference/deposits/request-deposit), [refund](/v1/api-reference/refunds/request-refund)) the response will confirm whether the transaction was __accepted for processing or rejected__. 

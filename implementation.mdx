...
Failed payments usually take longer to process, leaving the customer waiting for clarity for longer. Read more about our [availability](/v1/api-reference/toolkit/availability) endpoint.

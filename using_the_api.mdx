...
## Authentication
    ...
    The pawaPay Merchant API uses bearer token for authentication. An authorization header is required for all calls to the pawaPay Merchant APIs except for [MMO Availability](/v1/api-reference/toolkit/availability). 

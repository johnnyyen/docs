...
<CardGroup cols={2}>
    <Card title="Waiting for a callback" icon="webhook" href="payout-callback" horizontal="true">
        If you have configured callbacks, just wait for it.
    </Card>
    <Card title="Checking the status" icon="code-compare" href="check-payout-status" horizontal="true">

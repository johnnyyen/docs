...
If you have not configured callbacks, you can always call our [Check Payout Status](check-payout-status) endpoint to get the latest status and details of a specific payout request. 

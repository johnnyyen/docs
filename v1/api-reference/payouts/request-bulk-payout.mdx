...
Bulk payouts operation allows you to initiate multiple disbursements for asynchronous processing. Read more about [Payouts](/payouts).
...
Each individual request can become either ACCEPTED, ENQUEUED, REJECTED or DUPLICATE_IGNORED:

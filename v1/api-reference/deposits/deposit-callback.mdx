...
If you have not configured callbacks, you can always call our [Check Deposit Status](check-deposit-status) endpoint to get the latest status and details of a specific deposit request. 

### Headers

<Info> Following headers are only included if you have enabled "Sign all callbacks" from the pawaPay Dashboard. Read more about it from the pawaPay Dashboard documentation TODO.</Info>
...
<ParamField header="Signature-Input" type="String">
    ignature input according to [RFC-9421](https://datatracker.ietf.org/doc/rfc9421/).
</ParamField>

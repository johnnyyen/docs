...
### How do i find out the final status of this refund?
...
<CardGroup cols={2}>
    <Card title="Waiting for a callback" icon="webhook" href="refund-callback" horizontal="true">
        If you have configured callbacks, just wait for it.
    </Card>
    <Card title="Checking the status" icon="code-compare" href="check-refund-status" horizontal="true">

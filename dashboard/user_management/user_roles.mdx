...
- You can disable a user by pressing the disable icon in the user's "Actions" column.
...
- You can enable users by pressing on the enable icon in the user's "Actions" column.

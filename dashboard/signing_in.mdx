...
If you opt for Google-based authentication, your organization must already utilize [Google Workspace](https://workspace.google.com/), or a comparable service where Google manages email addresses. This feature facilitates a seamless login process, allowing users to access our portal using their existing Google accounts.

...
This functionality is available to users with the Batch Disbursements role. Read more about [User roles](/v1/docs/user-roles).
...
![Batch Disbursement Template](https://cdn.document360.io/32e6fd9e-30a7-4a81-b2d6-2f89eb3bbb0d/Images/Documentation/bd1.png)
...
> **Please note!**  
> You can find all the supported Country, Telco, and Currency combinations from [our API docs](https://docs.pawapay.co.uk/#section/Using-the-API/Correspondents).

### Example batch disbursement file

![Example Batch Disbursement File](https://cdn.document360.io/32e6fd9e-30a7-4a81-b2d6-2f89eb3bbb0d/Images/Documentation/bd3.png)
...
![Batch Disbursement Validation](https://cdn.document360.io/32e6fd9e-30a7-4a81-b2d6-2f89eb3bbb0d/Images/Documentation/bd4.png)
...
![Schedule Payment](https://cdn.document360.io/32e6fd9e-30a7-4a81-b2d6-2f89eb3bbb0d/Images/Documentation/image-1668419693254.png)
...
Pressing the icon will expand your view and provide more details on the ongoing incidents and upcoming maintenance.

<Frame>
    <img src="/images/dashboard/incidents_expanded.png" />
</Frame>

Pressing "Read more" will direct you to the incident page with more information about it.

The "Status Page" button will direct you to our [status page](https://status.pawapay.cloud/).
...
This allows you to inform your customers proactively about MMO downtime. 

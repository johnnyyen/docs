...
![Wallet Search](https://cdn.document360.io/32e6fd9e-30a7-4a81-b2d6-2f89eb3bbb0d/Images/Documentation/image-1668415873845.png)
...
You will be asked to confirm this action and then taken to the [History](https://docs.pawapay.co.uk/#operation/createDesposit) page to download the resulting CSV file.

> **Please note!**  
> - You can choose up to a **one month period** at a time.
> - All transactions for the period will be exported (no 10,000 transaction limit).
> - The export might take some time to generate. The [History](https://docs.pawapay.co.uk/#operation/createDesposit) page will refresh itself automatically to show the latest status.
...
| Transaction ID   | The ID of this transaction as specified by you through our API. You can read more about transaction IDs from [our API docs](https://docs.pawapay.co.uk/#operation/createDesposit). |
...
| Type             | The type of this transaction. See the list of all [transaction types](https://docs.pawapay.co.uk/#operation/createDesposit) below. |
...
| Top up                         | Funds sent by you have been added to your wallet. Read more about [Topping up your wallets](https://docs.pawapay.co.uk/#operation/createDesposit). |
| Withdrawal                    | Funds withdrawn from your wallet to be settled to your bank. Read more about [Settling your wallets](https://docs.pawapay.co.uk/#operation/createDesposit). |

...
| Financial Transaction ID | The ID for this transaction specified by the MMO. <br /> **Please note!** This ID is visible to your customers in their SMS receipts or Mobile Money applications transaction history. |
| Requested amount       | The amount on the original deposit request.                                                      |
...
| MMO                    | The Mobile Money Operator who carried out the transaction.                                        |

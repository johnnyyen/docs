...
| Detail | Description |
|--------|-------------|
| MMO transaction ID | This is the ID that the customer would see for this transaction. <br /> *Particularly important for reconciling payments that do not appear in our dashboard or are not in a final state. Read more about [Transaction statuses](/dashboard/transactions/transaction_statuses) .*

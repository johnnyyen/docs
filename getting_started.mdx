...
<Steps>
    ...
    <Step title="Set up callbacks">
        Sign in to the sandbox dashboard and go to [System configuration>Callback URLs](https://dashboard.sandbox.pawapay.cloud/#/system/callback-url).
        
        Press "Edit" and paste the callback URL you copied from Postman into the input boxes.
